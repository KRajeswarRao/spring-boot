...
public class ProductController {
	...
	@PostMapping("/save")
	public ResponseEntity<Product> addProduct(@RequestBody Product product) { // RequestBody converts json to object
	...
	public ResponseEntity<?> fetchProductById(@PathVariable("demoid") int productId) {
