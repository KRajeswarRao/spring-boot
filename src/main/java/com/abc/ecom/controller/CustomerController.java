...
public class CustomerController {
	...
	@PostMapping("/save")
	public ResponseEntity<Customer> addCustomer(@RequestBody Customer customer) { // RequestBody converts json to object
	...
	public ResponseEntity<?> fetchCustomerById(@PathVariable("demoid") int customerId) {
